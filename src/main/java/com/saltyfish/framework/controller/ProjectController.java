...
public class ProjectController {
    ...
    public Response getSummary(@RequestParam("userId") Integer userId,
    ...
    @RequestMapping("/addProjectImages")
    public Response addConservationImages(@RequestParam("userId") Integer userId,
                                          @RequestParam("token") String token,
                                          @RequestParam("timeStamp") Long timeStamp,
                                          @RequestParam("projectId") Integer projectId,
        ...
        try{
            if (!authService.checkLogin(userId,token)){
                ...
                switch (waterConservationEntity.getCategory()){
                    case "渡槽":
                        waterConservationEntity.getProjectMark().getAqueduct().setImage(imagePath);
                        break;
                    case "桥梁":
                        waterConservationEntity.getProjectMark().getBridge().setImage(imagePath);
                        break;
                    case "渠道":
                        waterConservationEntity.getProjectMark().getChannel().setImage(imagePath);
                        waterConservationEntity.getProjectMark().getChannel().setPlaneSketch(planeSketchPath);
                        break;
                    case "涵洞":
                        waterConservationEntity.getProjectMark().getCulvert().setImage(imagePath);
                        break;
                    case "塘坝":
                        waterConservationEntity.getProjectMark().getDam().setImage(imagePath);
                        break;
                    case "深水井":
                        waterConservationEntity.getProjectMark().getDeepWells().setImage(imagePath);
                        break;
                    case "管滴灌":
                        waterConservationEntity.getProjectMark().getDripIrrigationPipe().setImage(imagePath);
                        break;
                    case "大口井":
                        waterConservationEntity.getProjectMark().getGreatWells().setImage(imagePath);
                        break;
                    case "水电站":
                        waterConservationEntity.getProjectMark().getHydropower().setInternalImage(internalImagePath);
                        waterConservationEntity.getProjectMark().getHydropower().setExternalImage(externalImagePath);
                        break;
                    case "水塘":
                        waterConservationEntity.getProjectMark().getPond().setImage(imagePath);
                        break;
                    case "泵站":
                        waterConservationEntity.getProjectMark().getPumpStation().setExternalImage(externalImagePath);
                        waterConservationEntity.getProjectMark().getPumpStation().setInternalImage(internalImagePath);
                        break;
                    case "水闸":
                        waterConservationEntity.getProjectMark().getSluice().setImage(imagePath);
                        break;
                    case "河道":
                        waterConservationEntity.getProjectMark().getWatercourse().setMiddleImage(middleImagePath);
                        waterConservationEntity.getProjectMark().getWatercourse().setStartImage(startImagePath);
                        waterConservationEntity.getProjectMark().getWatercourse().setEndImage(endImagePath);
                        waterConservationEntity.getProjectMark().getWatercourse().setSectionImage(sectionImagePath);
                        break;
                    case "水厂":
                        waterConservationEntity.getProjectMark().getWaterWorks().setImage(imagePath);
                        break;
                    default:
                        break;
                }
    ...
    public Response addProject(@RequestParam("userId") Integer userId,
        ...
        try {
            ...
            waterConservationRepository.save(waterConservationEntity);
            Map<String,Object> data = new HashMap<>();
            data.put("projectId",waterConservationEntity.getId());
            response.setCode(HttpStatus.OK.value());
            response.setData(data);
            return response;
        } catch (Exception e) {
    ...
    public Response modifyConservation(@RequestParam("userId") Integer userId,
                                       ...
                                       @RequestParam("townId") Integer townId,
                                       @RequestParam("villageId") Integer villageId,
                                       @RequestParam(value = "countyId",required = false,defaultValue = "1") Integer countyId,
                                       @RequestParam(value = "groupId", required = false) Integer groupId,
                                       @RequestParam("code") String code,
                                       @RequestParam("name") String name,
                                       @RequestParam(value = "remark", required = false, defaultValue = "") String remark,

...
# Database: exciting
# Generation Time: 2016-09-22 15:49:05 +0000
# ************************************************************
...
INSERT INTO `bridge` (`id`, `cross_count`, `cross_length`, `image`, `length`, `load_standard`, `structure_and_material`, `watercourse_location`, `width`)
VALUES
	(1,'2','100',NULL,'100','20','塑料','蓉江河','100');
...
CREATE TABLE `channel` (
  ...
  `sum_lining_section_size` varchar(255) DEFAULT NULL,
  `sum_section_size` varchar(255) DEFAULT NULL,
  `sum_seepage_canal_length` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `investment` (
  ...
  `invest_resource` varchar(255) DEFAULT NULL,
  `project_detail_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `project_detail` (`id`, `create_time`, `is_delete`, `update_time`, `construct_time`, `construct_unit`, `others`, `project_name`, `sum_estimate_investment`, `sum_fact_investment`)
VALUES
	(1,'2016-09-19 23:27:12',0,'2016-09-19 23:27:12','2016-12-12','物联网工程学院','','江南大学大水桥','','');
...
VALUES
	(1,'2016-09-08 12:00:00',0,'2016-09-22 23:32:52',NULL,1,1,'weck','AEw8/HWJ4q39RI8Y3VUCVzUSn7M1mwh1dNrVvs2H+HK8iz3SNy22jcBid2DARij5xbMhCzuUkc+QQ5VzNq53Ua4=',NULL,'weck','ci6Yl0pXZTr7Ikw2sFEyy4MjQgdyZpSGeKi+VZnIVJ0=','62b2badccb154fb4a7220b87246e5210',1,1);
...
INSERT INTO `water_conservation` (`id`, `create_time`, `is_delete`, `update_time`, `category`, `code`, `construct_unit`, `manage_model`, `manager`, `name`, `property_owner`, `remark`, `situation`, `county_id`, `group_id`, `location_id`, `project_mark_id`, `town_id`, `village_id`, `construct_time`)
VALUES
	(1,'2016-09-08 12:08:23',0,'2016-09-08 12:08:23','渡槽','abcd','','自管','','什么鬼渡槽','','','破损',1,2,2,1,3,2,NULL),
	(2,'2016-09-08 14:25:05',0,'2016-09-08 14:25:05','渡槽','abcd','','自管','','什么鬼渡槽','','','破损',1,1,3,2,1,1,NULL),
	(3,'2016-09-08 14:26:06',0,'2016-09-08 14:26:06','渡槽','abcd','','自管','','什么鬼渡槽','','','完好',1,2,4,3,3,2,NULL),
	(4,'2016-09-08 21:28:47',0,'2016-09-08 21:28:47','渡槽','abcd','','自管','','什么鬼渡槽','','','完好',1,1,5,4,1,1,NULL),
	(5,'2016-09-17 20:26:22',0,'2016-09-17 20:26:22','泵站','ssssssvbb','vbb','委托管理','ghh','ghh','vbb','www','cbbb',1,1,11,5,1,1,NULL),
	(6,'2016-09-17 20:27:03',0,'2016-09-17 20:27:03','泵站','ssssssvbb','vbb','委托管理','ghh','ghh','vbb','www','cbbb',1,1,12,6,1,1,NULL),
	(7,'2016-09-17 21:39:38',0,'2016-09-17 21:39:38','泵站','ssssss','','不限','','','','www','完好',1,1,14,7,1,1,NULL),
	(9,'2016-09-17 21:39:38',0,'2016-09-17 21:39:38','桥梁','sb','sb','不限','sb','烂尾桥','智障','呵呵','完好',1,1,1,8,1,1,'猴年马月');
